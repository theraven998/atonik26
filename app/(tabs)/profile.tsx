...
const Profile: React.FC = () => {
  ...
  useLayoutEffect(() => {
    navigation.setOptions({
      headerShown: false, // Oculta el encabezado     // <Panel isVisible={isVisible} togglePanel={togglePanel} closePanel={closePanel} /> // Panel de notificaciones
    });
  }, [navigation]);
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.cajaeventos}>
        ...
        <View style={styles.cajaeventoshistorialfechas}>
      ...
      <View style={styles.cajahistorial}>
      <Text style={styles.mensaje}>Historial de eventos</Text>
      <ScrollView horizontal showsHorizontalScrollIndicator={false}>
